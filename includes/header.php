...
<head>
    ...
    <style>
        /* Inline critical styles for header */
        header {
            height: auto;
            padding: 0.5rem 0;
        }
        ...
        <nav id="menu" class="hidden md:flex relative">
            <ul class="flex space-x-8 items-center">
                ...
                <li class="relative group">
                    ...
                    <li><a href="/blog.php" class="navbar-link block text-center">Blog</a></li>
                        <li><a href="/telecharger-plaquette.php" class="navbar-link block text-center">Plaquette commerciale</a></li>
                        <li><a href="/formulaire-pro.php" class="navbar-link block text-center">Devis Pro</a></li>
                    </ul>
                </li>
